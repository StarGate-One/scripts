...
set VCPKG_DOWNLOADS=%_root_drive%\downloads
set VCPKG_ENV_PASSTHROUGH=_IsNativeEnvironment;CMAKE_TOOLCHAIN_FILE;IFCPATH;INCLUDE;LIB;LIBPATH;PATH;PreferredToolArchitecture;TEMP;TMP;VCPKG_BINARY_SOURCES;VCPKG_CHAINLOAD_TOOLCHAIN_FILE;VCPKG_CMAKE_SYSTEM_NAME;VCPKG_CRT_LINKAGE;VCPKG_DEFAULT_BINARY_CACHE;VCPKG_DEFAULT_HOST_TRIPLET;VCPKG_DEFAULT_TRIPLET;VCPKG_DISABLE_METRICS;VCPKG_DOWNLOADS;VCPKG_ENV_PASSTHROUGH;VCPKG_ENV_PASSTHROUGH_UNTRACKED;VCPKG_FEATURE_FLAGS;VCPKG_FORCE_SYSTEM_BINARIES;VCPKG_KEEP_ENV_VARS;VCPKG_LIBRARY_LINKAGE;VCPKG_LOAD_VCVARS_ENV;VCPKG_NO_CLEAN;VCPKG_NUGET_REPOSITORY;VCPKG_PLATFORM_TOOLSET;VCPKG_ROOT;VCPKG_TARGET_ARCHITECTURE;VCPKG_USE_NUGET_CACHE;VCPKG_VISUAL_STUDIO_PATH;VSCMD_SKIP_SENDTELEMETRY
